...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_mobile_menu__WEBPACK_IMPORTED_MODULE_2__["addJavaScriptClasses"])();
  Object(_modules_mobile_menu__WEBPACK_IMPORTED_MODULE_2__["listenMenuToggle"])();
  Object(_modules_local_storage__WEBPACK_IMPORTED_MODULE_3__["getLocalStorage"])();
}); // ---------------------------------
...
var setLocalStorage = function setLocalStorage(userName, userPhone, userEmail) {
  userName.addEventListener('focusout', function (evt) {
    localStorage.setItem(evt.target.id, userName.value);
  });
  userPhone.addEventListener('focusout', function (evt) {
...
/*!***********************************!*\
  !*** ./js/modules/mobile-menu.js ***!
  \***********************************/
/*! exports provided: addJavaScriptClasses, listenMenuToggle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addJavaScriptClasses", function() { return addJavaScriptClasses; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "listenMenuToggle", function() { return listenMenuToggle; });
var addJavaScriptClasses = function addJavaScriptClasses() {
...
var checkIfMenuOpened = function checkIfMenuOpened(header) {
...
var openMenu = function openMenu(header, logoMenu, menuToggle) {
...
var closeMenu = function closeMenu(header, logoMenu, menuToggle) {
...
var listenMenuToggle = function listenMenuToggle() {
  var header = document.querySelector('.page-header');
  var logoMenu = header.querySelector('.logo-menu');
  var menuToggle = header.querySelector('.logo-menu__menu-toggle');
